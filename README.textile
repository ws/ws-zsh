...
@curl -L https://raw.githubusercontent.com/ws/ws-zsh/master/tools/install.sh | sh@

h4. via `wget`

@wget --no-check-certificate https://raw.githubusercontent.com/ws/ws-zsh/master/tools/install.sh -O - | sh@
...
@curl -L https://raw.github.com/ws/ws-zsh/master/tools/install.sh | ZSH=~/.dotfiles/zsh sh@
...
1. Clone the repository
  ...
  @git clone git://github.com/ws/ws-zsh.git ~/.oh-my-zsh@
